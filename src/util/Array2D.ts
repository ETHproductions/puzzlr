class Array2D<T> {
     ...
     */
    constructor(width: number, height?: number, fill?: any);
    constructor(arr: any[][]);
    constructor(arr: any[], width: number);
    constructor(arr2d: Array2D<T>);
    constructor(width: any, height?: any, fill?: any) {
     ...
     * array of data.
     */
    static from1D<T>(data: T[], width: number, height?: number) {
     ...
     */
    map(func: (item: T, pos: { x: number, y: number, i: number }, arr: Array2D<T>) => T) {
